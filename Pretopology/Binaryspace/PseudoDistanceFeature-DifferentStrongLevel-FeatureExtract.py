...
def FeaturesExtract():
    ...
    for line in lines:
        ...
        # pseudo distance with strong level k = 1
        A = [X]
        B = [Y]
        psdis_k_1 = pseudo_distance(A, B, 1)
        print('psdis_k_1: ', psdis_k_1)

        # pseudo distance with strong level k = 2
        psdis_k_2 = pseudo_distance(A, B, 2)
        print('psdis_k_2: ', psdis_k_2)

        # pseudo distance with strong level k = 3
        psdis_k_3 = pseudo_distance(A, B, 3)
        print('psdis_k_3: ', psdis_k_3)
        print("----------------------------------------------")

        with open("Dataset_Features_PseudoDistance_DifferentStrongLevels.txt", "a") as f:
            f.write('{},'.format(X))
            f.write('{},'.format(Y))
            f.write('{},'.format(psdis_k_1))
            f.write('{},'.format(psdis_k_2))
            f.write('{},'.format(psdis_k_3))
